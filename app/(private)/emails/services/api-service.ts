...
import { GET_EMAIL_PROSPECTS_QUERY, REGENERATE_EMAIL_MUTATION, REMOVE_EMAIL_MUTATION, SEND_EMAIL_MANY_MUTATION, SEND_EMAIL_MUTATION, TRUNCATE_EMAIL_MUTATION, UPDATE_EMAIL_CONTENT_MUTATION } from "../_hooks/queries";
...
export const removeEmailApi = async (ids: string[]) => {
    return request(GRAPHQL_BASE_URL, REMOVE_EMAIL_MUTATION, { ids })
}
...
export const truncateEmailApi = async () => {
    return request(GRAPHQL_BASE_URL, TRUNCATE_EMAIL_MUTATION)
}