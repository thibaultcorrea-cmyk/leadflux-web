...
export interface IS3StorageWriteRepository {
    ...
    /**
     * Upload multipart (gros fichiers) : decoupe et envoie les parts en
     * parallele, onProgress est notifie a chaque part envoyee. partSize
     * (octets) est optionnel, cf. UploadMultipartFileDto.
     */
    uploadMultipart: (input: UploadMultipartFileDto & { body: Buffer | Readable }, onProgress?: S3UploadProgressListener) => Promise<S3UploadResult>
